...
describe('calculateVersionBumpFromChangelog', () => {
	...
	it('should return major version bump for Keep a Changelog Removed', () => {
		expect(
			calculateVersionBumpFromChangelog([
				'## Unreleased',
				'### Removed',
	...
	it('should return minor version bump for Keep a Changelog Added', () => {
		expect(
			calculateVersionBumpFromChangelog([
				'## Unreleased',
				'### Added',
	...
	it('should return patch for Keep a Changelog Fixed', () => {
		expect(
			calculateVersionBumpFromChangelog([
				'## Unreleased',
				'### Fixed',
