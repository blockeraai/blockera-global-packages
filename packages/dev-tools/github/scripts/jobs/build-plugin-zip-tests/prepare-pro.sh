...
export BLOCKERA_WP_ENV_FALLBACK_CONFIG="${BLOCKERA_WP_ENV_FALLBACK_CONFIG:-general}"
export BLOCKERA_WP_ENV_DEFAULT_PLUGIN="${BLOCKERA_WP_ENV_DEFAULT_PLUGIN:-https://github.com/blockeraai/blockera/tree/master}"
