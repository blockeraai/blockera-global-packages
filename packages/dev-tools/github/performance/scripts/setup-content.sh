...
SCENARIOS_FILE="${SCENARIOS_FILE:-$SCENARIOS_FILE_DEFAULT}"
OUT_DIR="${PERF_RESULTS_DIR:-$PERF_RESULTS_DEFAULT}"
HOST_FIXTURE="${ROOT_DIR}/tests/fixtures/complex-2/input.html"
PLUGIN_SLUG="${BLOCKERA_PERF_PLUGIN_SLUG:-$PLUGIN_SLUG_DEFAULT}"
EVAL_FILE="${BLOCKERA_PERF_PUBLISH_EVAL_FILE:-wp-content/plugins/${PLUGIN_SLUG}/${PERF_SCRIPTS_DIR}/publish-page-1.php}"
SLUG="perf-page-1"
