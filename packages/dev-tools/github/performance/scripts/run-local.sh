...
PERF_RESULTS_DIR="${PERF_RESULTS_DIR:-$PERF_RESULTS_DEFAULT}"
...
bash "${PERF_SCRIPTS_DIR}/setup-server-timing.sh"
bash "${PERF_SCRIPTS_DIR}/setup-content.sh"
bash "${PERF_SCRIPTS_DIR}/run-benchmarks.sh"
