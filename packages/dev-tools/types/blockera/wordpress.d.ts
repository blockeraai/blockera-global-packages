...
// @wordpress/data: do not redeclare select/dispatch/useSelect/useDispatch.
// Official types return CurriedSelectorsOf / DispatchReturn; a stub that
// returns StoreDescriptor<Config> makes every store look like ReduxStoreConfig.
...
declare module '@wordpress/components' {
	...
	export interface ConfirmDialogProps {
		...
		onCancel?: () => void;
		onConfirm?: () => void;
		size?: 'small' | 'medium' | 'large' | 'fill' | string;
	}
...
declare module '@wordpress/keyboard-shortcuts/build-types/store/actions' {
	export interface ShortcutConfig {
		icon?: unknown;
	}
}

declare module '@wordpress/global-styles-engine' {
	export interface BasePreset {
		[key: string]: unknown;
	}
}

declare module '@wordpress/global-styles-engine/build-types/types' {
	export interface BasePreset {
		[key: string]: unknown;
	}
}
