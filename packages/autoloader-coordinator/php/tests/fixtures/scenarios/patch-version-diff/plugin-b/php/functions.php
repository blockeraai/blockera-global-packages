<?php
/**
 * Name Utils - Version 1.0.1 (Plugin B)
...
if ( ! defined( 'BLOCKERA_NAME_UTILS_VERSION' ) ) {
    define( 'BLOCKERA_NAME_UTILS_VERSION', '1.0.1' );
}
...
// v1.0.1 bugfix indicator
if ( ! function_exists( 'blockera_name_utils_has_bugfix' ) ) {
    function blockera_name_utils_has_bugfix(): bool {
        return true;
    }
}
