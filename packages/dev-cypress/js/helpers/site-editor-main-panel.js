...
export const SITE_EDITOR_TEST_IDS = {
	...
	reset: 'blockera-site-editor-reset',
	resetThemeModal: 'blockera-site-editor-reset-theme-modal',
	resetThemeOptions: 'blockera-site-editor-reset-theme-options',
	resetOptionStyles: 'blockera-site-editor-reset-option-styles',
	resetOptionTemplates: 'blockera-site-editor-reset-option-templates',
	resetOptionTemplateParts:
		'blockera-site-editor-reset-option-template-parts',
	resetOptionHomepage: 'blockera-site-editor-reset-option-homepage',
	resetThemeConsent: 'blockera-site-editor-reset-theme-consent',
	resetThemeCancel: 'blockera-site-editor-reset-theme-cancel',
	resetThemeConfirm: 'blockera-site-editor-reset-theme-confirm',
	/** @deprecated Use `reset`. Kept for older specs. */
	resetStyles: 'blockera-site-editor-reset',
	...
	identityLogoChoose: 'blockera-site-editor-identity-logo',
	identityIcon: 'blockera-site-editor-identity-icon',
